...
const SUPP_DB = {
  'Nervous System Regulator':[
    ...
    {name:'5-HTP',               dose:'100mg 1hr before bed',    directions:'Take 1 hour before bed',      code:'TOGNIETTI10', link:'https://nuethix.com'},
    {name:'Magnesium Glycinate',  dose:'350mg 1hr before bed',    directions:'Take 1 hour before bed',      code:'TOGNIETTI10', link:'https://nuethix.com'},
    {name:'L-Theanine (PM)',      dose:'200mg 1hr before bed',    directions:'Take 1 hour before bed',      code:'TOGNIETTI10', link:'https://nuethix.com'},
    {name:'Ashwagandha',          dose:'2 capsules 1hr before bed',directions:'Take 1 hour before bed',     code:'TOGNIETTI10', link:'https://nuethix.com'},
  ],
  '5R Gut Protocol':[
    {name:'Biofilm Resolve',      dose:'2 caps 45-60 min before meals 1,3,5',directions:'7-Day Prep Phase. Take on empty stomach',code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Saccharomyces Boulardii',dose:'2 caps with meal 1, 2 caps with last meal',directions:'Weeks 1-6',code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Fungal Pro',           dose:'2 caps 2x daily (meal 1 and last meal)',directions:'Weeks 1-6. Discontinue after 6 weeks.',code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Mastic Gum',          dose:'1000mg (2 caps) with meals 2 and 5',directions:'Weeks 1-6',code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'FC Extinguish',       dose:'2 caps 2x daily',          directions:'Weeks 1-6',                  code:'TOGNIETTI10',link:'https://nuethix.com'},
    ...
    {name:'Zinc Carnosine',      dose:'1 tablet 2x daily meals 1 and 4',directions:'Weeks 1-6',           code:'',           link:'https://amazon.com'},
    {name:'Cort Eaze',           dose:'2 caps waking, 2 caps meal 3, 2 caps bed',directions:'Weeks 1-6',  code:'TOGNIETTI10',link:'https://nuethix.com'},
  ...
  'PCOS Protocol':[
    ...
    {name:'Calcium D-Glucarate', dose:'1000mg with Meal 1 and Meal 5',directions:'Daily',                 code:'',           link:'https://amazon.com'},
    {name:'L-Carnitine',         dose:'10ml once daily between meals',directions:'Daily',                  code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'N-Acetyl-Cysteine (NAC)',dose:'1800mg daily',           directions:'Take on empty stomach 30 min before meals',code:'',link:'https://amazon.com'},
    {name:'Saw Palmetto',        dose:'2 caps Meal 1, 2 caps last meal',directions:'Daily',               code:'',           link:'https://amazon.com'},
  ],
  'Thyroid Protocol':[
  ...
  'Adrenal Deficient Protocol':[
    {name:'Cort Eaze',           dose:'2 caps waking, meal 3, meal 5, before bed',directions:'4x daily',  code:'TOGNIETTI10',link:'https://nuethix.com'},
  ...
  'Methylation Protocol (1hr Before Bed)':[
    {name:'TMG (Trimethylglycine)',dose:'4g',                      directions:'1 hour before bed',         code:'',           link:'https://amazon.com'},
    {name:'Glycine',             dose:'4g',                        directions:'1 hour before bed',         code:'',           link:'https://amazon.com'},
    {name:'L-Methionine',        dose:'2.4g (2400mg)',             directions:'1 hour before bed',         code:'',           link:'https://amazon.com'},
    {name:'Methyl Folate/B12',   dose:'1000mcg (1 full dropper)', directions:'1 hour before bed',         code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Inositol',            dose:'6g',                        directions:'1 hour before bed',         code:'',           link:'https://amazon.com'},
    {name:'Magnesium',           dose:'200mg',                     directions:'1 hour before bed',         code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Vitamin D3 + K2',     dose:'5000 IU',                   directions:'1 hour before bed',         code:'TOGNIETTI10',link:'https://nuethix.com'},
  ],
  'Histamine/MCAS Protocol':[
    {name:'Quercetin',           dose:'1 cap meals 1,2,4',         directions:'With food',                 code:'',           link:'https://amazon.com'},
    {name:'Bromelain',           dose:'2 caps meals 1,3,4',        directions:'With food',                 code:'',           link:'https://amazon.com'},
    {name:'Vitamin C',           dose:'2 caps meals 1,3,4',        directions:'With food — DAO cofactor',  code:'',           link:'https://amazon.com'},
    {name:'GABA',               dose:'1 cap meal 1, 1 cap before bed',directions:'Daily',                 code:'',           link:'https://amazon.com'},
    {name:'DAO Enzyme',          dose:'1 cap 15min before meals 1,3,4',directions:'Before meals',         code:'',           link:'https://amazon.com'},
    {name:'Probiotics HistaminX',dose:'1 cap upon waking',         directions:'Daily fasted',              code:'',           link:'https://amazon.com'},
    {name:'Zinc + Copper',       dose:'2 caps with meal 1',        directions:'Daily',                     code:'',           link:'https://amazon.com'},
    {name:'SAMe',               dose:'3 caps 1hr before bed',      directions:'Before bed',                code:'',           link:'https://amazon.com'},
    {name:'Vitamin B6',          dose:'1 cap with meal 1',         directions:'Daily',                     code:'',           link:'https://amazon.com'},
  ],
  'NuEthix Products':[
    {name:'Cort-Eaze',           dose:'As prescribed',             directions:'See adrenal protocol',      code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Estro-Cort',          dose:'As prescribed',             directions:'',                          code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Thyro-Boost+',        dose:'As prescribed',             directions:'',                          code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Liposomal L-Carnitine',dose:'As prescribed',            directions:'',                          code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Nu-Multi',            dose:'3 caps with meal 1',        directions:'Daily',                     code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'GDA-MAX Pro',         dose:'As prescribed',             directions:'',                          code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Nu-Lytes Electrolytes',dose:'As prescribed',            directions:'',                          code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Nu-D3+K2',            dose:'1 tab daily',              directions:'With meal',                  code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Prosorb+ Magnesium',  dose:'1 scoop before bed',        directions:'Nightly',                   code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Ashwagandha KSM-66',  dose:'As prescribed',             directions:'',                          code:'TOGNIETTI10',link:'https://nuethix.com'},
    ...
    {name:'Medipure Ultra',      dose:'1 scoop',                   directions:'As needed',                 code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Flora-Protect',       dose:'1 cap upon waking',         directions:'Fasted daily',              code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Bile Plus',           dose:'2 caps per meal',           directions:'With every meal',           code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Bloat Eaze',          dose:'1 scoop morning fasted',    directions:'Daily fasted',              code:'TOGNIETTI10',link:'https://nuethix.com'},
  ],
  'Extra Supplements':[
    {name:'5-HTP',               dose:'100mg',                     directions:'1 hour before bed',         code:'',link:'https://amazon.com'},
    {name:'L-Dopa',              dose:'As prescribed',             directions:'',                          code:'',link:'https://amazon.com'},
    {name:'Magnesium Glycinate', dose:'350mg',                     directions:'1 hour before bed',         code:'',link:'https://amazon.com'},
    {name:'Chasteberry',         dose:'As prescribed',             directions:'',                          code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Collagen',            dose:'As prescribed',             directions:'',                          code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Passion Flower Extract',dose:'As prescribed',           directions:'',                          code:'',link:'https://amazon.com'},
    {name:'Vitamin B12',         dose:'As prescribed',             directions:'',                          code:'',link:'https://amazon.com'},
    {name:'L-Theanine',          dose:'200-400mg',                 directions:'Morning or before bed',     code:'',link:'https://amazon.com'},
    {name:'Phosphatidylserine',  dose:'As prescribed',             directions:'',                          code:'',link:'https://amazon.com'},
    {name:'Methylfolate',        dose:'As prescribed',             directions:'',                          code:'',link:'https://amazon.com'},
    {name:'HCL with Pepsin',     dose:'As prescribed',             directions:'With protein meals',        code:'',link:'https://amazon.com'},
    ...
    {name:'Alpha Lipoic Acid',   dose:'300mg daily',               directions:'Away from food',            code:'',link:'https://amazon.com'},
    {name:'NAC',                 dose:'600-1200mg 2-3x daily',     directions:'Empty stomach or 30min before meals',code:'',link:'https://amazon.com'},
    {name:'TUDCA',               dose:'250-500mg 2x daily',        directions:'With meals — liver support',code:'',link:'https://amazon.com'},
    {name:'Niacin Flush',        dose:'As prescribed',             directions:'',                          code:'',link:'https://amazon.com'},
    {name:'Iodine',              dose:'225mcg daily',              directions:'With meal',                 code:'',link:'https://amazon.com'},
    {name:'L-Carnitine',         dose:'3g daily',                  directions:'Between meals',             code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Seeking Health Electrolytes',dose:'As prescribed',      directions:'',                          code:'',link:'https://amazon.com'},
    {name:'Blue Light Glasses',  dose:'Wear at night',             directions:'Wear 2hrs before bed',      code:'',link:'https://amazon.com'},
    {name:'Soy Isoflavones',     dose:'As prescribed',             directions:'',                          code:'',link:'https://amazon.com'},
    {name:'Vitamin B1',          dose:'As prescribed',             directions:'',                          code:'',link:'https://amazon.com'},
    {name:'Nulytes',             dose:'As prescribed',             directions:'',                          code:'TOGNIETTI10',link:'https://nuethix.com'},
    {name:'Bromelain',           dose:'As prescribed',             directions:'',                          code:'',link:'https://amazon.com'},
  ],
}
