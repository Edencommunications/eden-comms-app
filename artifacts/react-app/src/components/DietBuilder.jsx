...
const PD   = h => `https://www.practitionerdepot.com/products/${h}`

// ── SUPPLEMENT DATABASE (from your Google Sheets) ─────────────
const SUPP_DB = {
  'Nervous System Regulator':[
    {name:'Standardized Saffron', dose:'30mg upon waking',         directions:'Take upon waking',                              code:'TOGNIETTI10', link:NEX('standardized-saffron')},
    {name:'L-Theanine (AM)',      dose:'400mg upon waking',        directions:'Take upon waking',                              code:'TOGNIETTI10', link:NEX('l-theanine')},
    {name:'5-HTP',               dose:'100mg 1hr before bed',     directions:'Take 1 hour before bed',                       code:'TOGNIETTI10', link:NEX('5-htp')},
    {name:'Magnesium Glycinate',  dose:'350mg 1hr before bed',     directions:'Take 1 hour before bed',                       code:'TOGNIETTI10', link:NEX('prosorb-magnesium')},
    {name:'L-Theanine (PM)',      dose:'200mg 1hr before bed',     directions:'Take 1 hour before bed',                       code:'TOGNIETTI10', link:NEX('l-theanine')},
  ...
  '5R Gut Protocol':[
    {name:'Biofilm Resolve',        dose:'2 caps 45-60 min before meals 1,3,5', directions:'7-Day Prep Phase. Take on empty stomach',      code:'TOGNIETTI10', link:NEX('biofilm-resolve')},
    {name:'Saccharomyces Boulardii',dose:'2 caps with meal 1, 2 caps with last meal',directions:'Weeks 1-6',                               code:'TOGNIETTI10', link:NEX('saccharomyces-boulardii')},
    {name:'Fungal Pro',             dose:'2 caps 2x daily (meal 1 and last meal)',directions:'Weeks 1-6. Discontinue after 6 weeks.',       code:'TOGNIETTI10', link:NEX('fungal-pro')},
    {name:'Mastic Gum',            dose:'1000mg (2 caps) with meals 2 and 5',   directions:'Weeks 1-6',                                    code:'TOGNIETTI10', link:PD('mastic-gum')},
    {name:'FC Extinguish',         dose:'2 caps 2x daily',                      directions:'Weeks 1-6',                                    code:'TOGNIETTI10', link:NEX('fc-extinguish')},
    {name:'Oregano Pro',           dose:'4 tabs 3x daily (meals 1,3,5)',         directions:'Weeks 1-6',                                    code:'TOGNIETTI10', link:NEX('oregano-pro')},
    {name:'Bloat Eaze',            dose:'1 scoop daily with meal 1',             directions:'Weeks 1-6',                                    code:'TOGNIETTI10', link:NEX('bloat-eaze')},
    {name:'Glutamine',             dose:'20g daily with a meal',                 directions:'Weeks 1-6',                                    code:'TOGNIETTI10', link:NEX('nu-glutamine')},
    {name:'Opti-Pure',             dose:'3 caps with meal 1 and meal 4',         directions:'Weeks 1-6 then maintenance',                   code:'TOGNIETTI10', link:NEX('opti-pure')},
    {name:'Calcium D-Glucarate',   dose:'1000mg with meal 1 and meal 5',         directions:'Weeks 1-6',                                    code:'',            link:AMZ('Calcium D-Glucarate 1000mg')},
    {name:'Zinc Carnosine',        dose:'1 tablet 2x daily meals 1 and 4',       directions:'Weeks 1-6',                                    code:'',            link:AMZ('Zinc Carnosine supplement')},
    {name:'Cort Eaze',             dose:'2 caps waking, 2 caps meal 3, 2 caps bed',directions:'Weeks 1-6',                                  code:'TOGNIETTI10', link:NEX('cort-eaze')},
    {name:'Biotics Bile Plus',     dose:'2 caps per meal',                        directions:'Week 7 and beyond',                           code:'TOGNIETTI10', link:NEX('bile-plus')},
    {name:'Gut Defender',          dose:'2 caps with meal 1',                     directions:'Week 7+ maintenance 6 weeks',                  code:'TOGNIETTI10', link:NEX('gut-defender')},
  ],
  'PCOS Protocol':[
    {name:'NuBalance',              dose:'6 caps with Meal 1',              directions:'Daily',                                             code:'TOGNIETTI10', link:NEX('nubalance')},
    {name:'Calcium D-Glucarate',    dose:'1000mg with Meal 1 and Meal 5',   directions:'Daily',                                             code:'',            link:AMZ('Calcium D-Glucarate 1000mg')},
    {name:'L-Carnitine',            dose:'10ml once daily between meals',   directions:'Daily',                                             code:'TOGNIETTI10', link:NEX('liposomal-l-carnitine')},
    {name:'N-Acetyl-Cysteine (NAC)',dose:'1800mg daily',                    directions:'Take on empty stomach 30 min before meals',         code:'',            link:AMZ('N-Acetyl-Cysteine NAC 600mg')},
    {name:'Saw Palmetto',           dose:'2 caps Meal 1, 2 caps last meal', directions:'Daily',                                             code:'',            link:AMZ('Saw Palmetto supplement capsules')},
  ],
  'Thyroid Protocol':[
    {name:'Iodine',                dose:'225mcg daily with Meal 1',         directions:'Daily with food',                                   code:'',            link:AMZ('Iodine 225mcg supplement')},
    ...
    {name:'B12 Liposomal',          dose:'0.5ml (1/2 dropper) daily',        directions:'Daily',                                             code:'TOGNIETTI10', link:NEX('liposomal-b12')},
    {name:'Black Seed Oil',         dose:'10g daily',                        directions:'Daily',                                             code:'',            link:AMZ('Black Seed Oil supplement')},
  ],
  'Adrenal Deficient Protocol':[
    {name:'Cort Eaze',   dose:'2 caps waking, meal 3, meal 5, before bed',  directions:'4x daily',                                          code:'TOGNIETTI10', link:NEX('cort-eaze')},
    {name:'Relax Liposomal',dose:'2ml before bed',                           directions:'Nightly',                                           code:'TOGNIETTI10', link:NEX('relax-liposomal')},
  ...
  'Methylation Protocol (1hr Before Bed)':[
    {name:'TMG (Trimethylglycine)',dose:'4g',               directions:'1 hour before bed',                                                  code:'',            link:AMZ('TMG Trimethylglycine powder')},
    {name:'Glycine',               dose:'4g',               directions:'1 hour before bed',                                                  code:'',            link:AMZ('Glycine powder supplement')},
    {name:'L-Methionine',          dose:'2.4g (2400mg)',     directions:'1 hour before bed',                                                  code:'',            link:AMZ('L-Methionine 500mg capsules')},
    {name:'Methyl Folate/B12',     dose:'1000mcg (1 full dropper)',directions:'1 hour before bed',                                            code:'TOGNIETTI10', link:NEX('methyl-b12-folate')},
    {name:'Inositol',              dose:'6g',               directions:'1 hour before bed',                                                  code:'',            link:AMZ('Inositol powder supplement')},
    {name:'Magnesium',             dose:'200mg',            directions:'1 hour before bed',                                                  code:'TOGNIETTI10', link:NEX('prosorb-magnesium')},
    {name:'Vitamin D3 + K2',       dose:'5000 IU',          directions:'1 hour before bed',                                                  code:'TOGNIETTI10', link:NEX('nu-d3-k2')},
  ],
  'Histamine/MCAS Protocol':[
    {name:'Quercetin',          dose:'1 cap meals 1,2,4',              directions:'With food',                                              code:'',            link:AMZ('Quercetin supplement capsules')},
    {name:'Bromelain',          dose:'2 caps meals 1,3,4',             directions:'With food',                                              code:'',            link:AMZ('Bromelain enzyme supplement')},
    {name:'Vitamin C',          dose:'2 caps meals 1,3,4',             directions:'With food — DAO cofactor',                               code:'',            link:AMZ('Vitamin C 1000mg buffered')},
    {name:'GABA',              dose:'1 cap meal 1, 1 cap before bed',  directions:'Daily',                                                  code:'',            link:AMZ('GABA supplement 750mg')},
    {name:'DAO Enzyme',         dose:'1 cap 15min before meals 1,3,4', directions:'Before meals',                                           code:'',            link:AMZ('DAO enzyme histamine supplement')},
    {name:'Probiotics HistaminX',dose:'1 cap upon waking',             directions:'Daily fasted',                                           code:'',            link:AMZ('Seeking Health HistaminX probiotics')},
    {name:'Zinc + Copper',      dose:'2 caps with meal 1',             directions:'Daily',                                                  code:'',            link:AMZ('Zinc Copper balance supplement')},
    {name:'SAMe',              dose:'3 caps 1hr before bed',           directions:'Before bed',                                             code:'',            link:AMZ('SAMe 400mg supplement')},
    {name:'Vitamin B6',         dose:'1 cap with meal 1',              directions:'Daily',                                                  code:'',            link:AMZ('Vitamin B6 P5P supplement')},
  ],
  'NuEthix Products':[
    {name:'Cort-Eaze',              dose:'As prescribed', directions:'See adrenal protocol',  code:'TOGNIETTI10', link:NEX('cort-eaze')},
    ...
    {name:'Nu-Lytes Electrolytes',  dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('nu-lytes')},
    {name:'Nu-D3+K2',               dose:'1 tab daily',   directions:'With meal',              code:'TOGNIETTI10', link:NEX('nu-d3-k2')},
    {name:'Prosorb+ Magnesium',     dose:'1 scoop before bed', directions:'Nightly',           code:'TOGNIETTI10', link:NEX('prosorb-magnesium')},
    ...
    {name:'ISO-Perfect Protein',    dose:'1 scoop',       directions:'As needed',              code:'TOGNIETTI10', link:NEX('iso-perfect-protein')},
    ...
    {name:'Bile Plus',              dose:'2 caps per meal', directions:'With every meal',      code:'TOGNIETTI10', link:NEX('bile-plus')},
    {name:'Bloat Eaze',             dose:'1 scoop morning fasted', directions:'Daily fasted',  code:'TOGNIETTI10', link:NEX('bloat-eaze')},
    {name:'Fungal Pro',             dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('fungal-pro')},
    {name:'Biofilm Resolve',        dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('biofilm-resolve')},
    {name:'FC Extinguish',          dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('fc-extinguish')},
    {name:'Oregano Pro',            dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('oregano-pro')},
    {name:'Opti-Pure',              dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('opti-pure')},
    {name:'NuBalance',              dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('nubalance')},
    {name:'Gut Defender',           dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('gut-defender')},
    {name:'Relax Liposomal',        dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('relax-liposomal')},
    {name:'5-HTP',                  dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('5-htp')},
    {name:'L-Theanine',             dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('l-theanine')},
    {name:'Standardized Saffron',   dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('standardized-saffron')},
    {name:'Methyl B12 Folate',      dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('methyl-b12-folate')},
    {name:'Liposomal B12',          dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('liposomal-b12')},
  ],
  'Extra Supplements':[
    {name:'5-HTP',                  dose:'100mg',                    directions:'1 hour before bed',                             code:'TOGNIETTI10', link:NEX('5-htp')},
    {name:'L-Dopa',                 dose:'As prescribed',            directions:'',                                              code:'',            link:AMZ('L-Dopa Mucuna Pruriens supplement')},
    {name:'Magnesium Glycinate',    dose:'350mg',                    directions:'1 hour before bed',                             code:'TOGNIETTI10', link:NEX('prosorb-magnesium')},
    {name:'Chasteberry',            dose:'As prescribed',            directions:'',                                              code:'TOGNIETTI10', link:NEX('chasteberry')},
    {name:'Collagen',               dose:'As prescribed',            directions:'',                                              code:'TOGNIETTI10', link:NEX('collagen')},
    {name:'Passion Flower Extract', dose:'As prescribed',            directions:'',                                              code:'',            link:AMZ('Passion Flower Extract supplement')},
    {name:'Vitamin B12',            dose:'As prescribed',            directions:'',                                              code:'TOGNIETTI10', link:NEX('liposomal-b12')},
    {name:'L-Theanine',             dose:'200-400mg',                directions:'Morning or before bed',                         code:'TOGNIETTI10', link:NEX('l-theanine')},
    {name:'Phosphatidylserine',     dose:'As prescribed',            directions:'',                                              code:'',            link:AMZ('Phosphatidylserine supplement 200mg')},
    {name:'Methylfolate',           dose:'As prescribed',            directions:'',                                              code:'TOGNIETTI10', link:NEX('methyl-b12-folate')},
    {name:'HCL with Pepsin',        dose:'As prescribed',            directions:'With protein meals',                            code:'',            link:AMZ('HCL with Pepsin betaine supplement')},
    {name:'DIM',                    dose:'As prescribed',            directions:'',                                              code:'',            link:AMZ('DIM diindolylmethane supplement')},
    {name:'Black Seed Oil',         dose:'10g daily',                directions:'Daily',                                         code:'',            link:AMZ('Black Seed Oil supplement')},
    {name:'CoQ10',                  dose:'1500mg daily',             directions:'Daily',                                         code:'',            link:AMZ('CoQ10 Ubiquinol 200mg supplement')},
    {name:'Alpha Lipoic Acid',      dose:'300mg daily',              directions:'Away from food',                                code:'',            link:AMZ('Alpha Lipoic Acid 300mg')},
    {name:'NAC',                    dose:'600-1200mg 2-3x daily',    directions:'Empty stomach or 30min before meals',           code:'',            link:AMZ('NAC N-Acetyl Cysteine 600mg')},
    {name:'TUDCA',                  dose:'250-500mg 2x daily',       directions:'With meals — liver support',                    code:'',            link:AMZ('TUDCA liver supplement')},
    {name:'Niacin Flush',           dose:'As prescribed',            directions:'',                                              code:'',            link:AMZ('Niacin flush nicotinic acid supplement')},
    {name:'Iodine',                 dose:'225mcg daily',             directions:'With meal',                                     code:'',            link:AMZ('Iodine 225mcg supplement')},
    {name:'L-Carnitine',            dose:'3g daily',                 directions:'Between meals',                                 code:'TOGNIETTI10', link:NEX('liposomal-l-carnitine')},
    {name:'Seeking Health Electrolytes',dose:'As prescribed',        directions:'',                                              code:'',            link:AMZ('Seeking Health electrolyte powder')},
    {name:'Blue Light Glasses',     dose:'Wear at night',            directions:'Wear 2hrs before bed',                          code:'',            link:AMZ('blue light blocking glasses night')},
    {name:'Soy Isoflavones',        dose:'As prescribed',            directions:'',                                              code:'',            link:AMZ('Soy Isoflavones supplement')},
    {name:'Vitamin B1',             dose:'As prescribed',            directions:'',                                              code:'',            link:AMZ('Vitamin B1 Thiamine supplement')},
    {name:'Nulytes',                dose:'As prescribed',            directions:'',                                              code:'TOGNIETTI10', link:NEX('nu-lytes')},
    {name:'Bromelain',              dose:'As prescribed',            directions:'',                                              code:'',            link:AMZ('Bromelain enzyme supplement')},
  ],
}
