...
const SUPP_DB = {
  'Nervous System Regulator':[
    {name:'L-Theanine (AM)',      dose:'400mg upon waking',         directions:'Take upon waking',            code:'', link:'https://www.amazon.com/Nutricost-L-Theanine-200mg-240-Capsules/dp/B0731JC54K/'},
    {name:'5-HTP',               dose:'100mg 1hr before bed',      directions:'Take 1 hour before bed',      code:'', link:'https://www.amazon.com/dp/B01A1DL4DW'},
    {name:'Magnesium Glycinate',  dose:'350mg 1hr before bed',      directions:'Take 1 hour before bed',      code:'', link:'https://www.amazon.com/dp/B0CV2RSRFX'},
    {name:'L-Theanine (PM)',      dose:'200mg 1hr before bed',      directions:'Take 1 hour before bed',      code:'', link:'https://www.amazon.com/Nutricost-L-Theanine-200mg-240-Capsules/dp/B0731JC54K/'},
    {name:'Ashwagandha',          dose:'2 capsules 1hr before bed', directions:'Take 1 hour before bed',      code:'TOGNIETTI10', link:NEX('ashwagandha-ksm-66')},
    {name:'Rhodiola',             dose:'500mg upon waking',         directions:'Optional',                    code:'', link:'https://www.amazon.com/Nutricost-Rhodiola-Rosea-500mg-Capsules/dp/B079C2J9FP/'},
  ],
  '5R Gut Protocol':[
    ...
    {name:'Oregano Pro',           dose:'4 tabs 3x daily (meals 1,3,5)',       directions:'Weeks 1-6',         code:'TOGNIETTI10', link:'https://www.practitionerdepot.com/product/oregano-pro?variant=Default%20Title'},
    {name:'Berberine',             dose:'2000mg meals 1 & 3, 1000mg meal 5',   directions:'Weeks 4-6',         code:'', link:'https://www.amazon.com/Nutricost-Berberine-HCl-600mg-Capsules/dp/B079GH6V2Z/'},
    {name:'Allicin (Allimed)',     dose:'2 caps with meals 1, 3, and 5',       directions:'Weeks 4-6',         code:'', link:'https://westcoastmint.com/products/allimax-allimed-garlic-extract-450-mg?variant=39932048441453'},
    {name:'Bloat Eaze',            dose:'1 scoop daily with meal 1',           directions:'Weeks 1-6',         code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/bloat-eaze-pro?variant=42854686753001'},
    {name:'Glutamine',             dose:'20g daily with a meal',               directions:'Weeks 1-6',         code:'TOGNIETTI10', link:NEX('nu-glutamine')},
    {name:'Opti-Pure',             dose:'3 caps with meal 1 and meal 4',       directions:'Weeks 1-6 then maintenance', code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/opti-pure?variant=42315272585449'},
  ...
  'PCOS Protocol':[
    {name:'NuBalance',              dose:'6 caps with Meal 1',              directions:'Daily',                code:'TOGNIETTI10', link:NEX('nubalance')},
    {name:'Calcium D-Glucarate',    dose:'1000mg with Meal 1 and Meal 5',   directions:'Daily',                code:'', link:'https://www.amazon.com/Nutricost-Calcium-D-Glucarate-500mg-Capsules/dp/B09NPFFSVC/'},
    ...
    {name:'N-Acetyl-Cysteine (NAC)',dose:'1800mg daily',                    directions:'Take on empty stomach 30 min before meals', code:'', link:'https://www.amazon.com/Nutricost-N-Acetyl-L-Cysteine-600mg-Capsules/dp/B01CUQFKW4/'},
    {name:'Chasteberry',            dose:'As prescribed',                   directions:'Daily',                code:'TOGNIETTI10', link:'https://nuethix.com/products/chasteberry'},
    {name:'DIM',                    dose:'As prescribed',                   directions:'Daily',                code:'', link:'https://www.amazon.com/Nutricost-Diindolylmethane-BioPerine-Veggie-Capsules/dp/B01HQR0RZW/'},
    {name:'Soy Isoflavones',        dose:'As prescribed',                   directions:'Daily',                code:'', link:'https://www.amazon.com/Nutricost-Isoflavones-150mg-Veggie-Capsules/dp/B09NS3PKCH/'},
  ],
  'Thyroid Protocol':[
    {name:'Iodine',                dose:'225mcg daily with Meal 1',         directions:'Daily with food',       code:'', link:'https://www.amazon.com/dp/B00V9Q6IZQ'},
    {name:'Selenium (Brazil Nuts)', dose:'3 Brazil nuts with Meal 1',       directions:'Daily',                 code:'', link:''},
    {name:'ThyroBoost Plus',        dose:'2 capsules daily',                 directions:'Daily',                 code:'TOGNIETTI10', link:NEX('thyro-boost-plus')},
    {name:'B12 Liposomal',          dose:'0.5ml (1/2 dropper) daily',        directions:'Daily',                 code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/b12-liposomal?selling_plan=4335665385'},
    {name:'Black Seed Oil',         dose:'10g daily',                        directions:'Daily',                 code:'', link:'https://www.amazon.com/Organic-Black-Seed-Oil-Liquid/dp/B0B2R57WWC/'},
  ],
  'Adrenal Deficient Protocol':[
    {name:'Cort Eaze',       dose:'2 caps waking, meal 3, meal 5, before bed', directions:'4x daily',           code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/cort-eaze?variant=32244757364781'},
    {name:'Relax Liposomal', dose:'2ml before bed',                            directions:'Nightly',             code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/relax-liposomal?variant=32244904689709'},
    {name:'Ashwagandha',     dose:'2 caps with each Cort Eaze dose',           directions:'4x daily',            code:'TOGNIETTI10', link:NEX('ashwagandha-ksm-66')},
  ],
  'Methylation Protocol (1hr Before Bed)':[
    {name:'TMG (Trimethylglycine)',dose:'4g',                directions:'1 hour before bed', code:'', link:'https://www.amazon.com/dp/B01BCQ3RLE'},
    {name:'Glycine',               dose:'4g',                directions:'1 hour before bed', code:'', link:'https://www.amazon.com/dp/B09F83CPX8'},
    {name:'L-Methionine',          dose:'2.4g (2400mg)',      directions:'1 hour before bed', code:'', link:'https://www.amazon.com/dp/B09JJMQRY3'},
    {name:'Methyl Folate/B12',     dose:'1000mcg (1 full dropper)', directions:'1 hour before bed', code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/b12-liposomal?selling_plan=4335665385'},
    {name:'Inositol',              dose:'6g',                directions:'1 hour before bed', code:'', link:'https://www.amazon.com/dp/B08QC4V25L'},
    {name:'Magnesium',             dose:'200mg',             directions:'1 hour before bed', code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/prosorb-magnesium-new?variant=47369076703465'},
    {name:'Vitamin D3 + K2',       dose:'5000 IU',           directions:'1 hour before bed', code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/nu-d3-k2?variant=46760997322985'},
  ],
  'Histamine/MCAS Protocol':[
    {name:'Quercetin',            dose:'1 cap meals 1,2,4',              directions:'With food',                code:'', link:'https://www.amazon.com/dp/B01MU30S6Z'},
    {name:'Bromelain',            dose:'2 caps meals 1,3,4',             directions:'With food',                code:'', link:'https://www.amazon.com/Nutricost-Bromelain-500mg-Veggie-Capsules/dp/B07TK4ZTLP/'},
    {name:'Vitamin C',            dose:'2 caps meals 1,3,4',             directions:'With food — DAO cofactor', code:'', link:'https://www.amazon.com/Nutricost-Vitamin-Capsules-Vegetarian-Non-GMO/dp/B0B5FY7DKP/'},
    {name:'GABA',                 dose:'1 cap meal 1, 1 cap before bed', directions:'Daily',                   code:'', link:'https://www.amazon.com/Nutricost-Gamma-Aminobutyric-750mg-Capsules/dp/B09CXT8S6S/'},
    {name:'DAO Enzyme',           dose:'1 cap 15min before meals 1,3,4', directions:'Before meals',            code:'', link:'https://www.amazon.com/gp/product/B0F39X6ZPL/'},
    {name:'Probiotics HistaminX', dose:'1 cap upon waking',              directions:'Daily fasted',            code:'', link:'https://www.amazon.com/gp/product/B0773SY1X2/'},
    {name:'Zinc + Copper',        dose:'2 caps with meal 1',             directions:'Daily',                   code:'', link:'https://www.amazon.com/Nutricost-Copper-Capsules-Servings-Serving/dp/B0FR7MC4MF/'},
    {name:'SAMe',                 dose:'3 caps 1hr before bed',          directions:'Before bed',              code:'', link:'https://www.amazon.com/Nutricost-S-Adenosyl-L-Methionine-Serving-Servings-Capsules/dp/B09JJMQRY3/'},
    {name:'Vitamin B6 (P5P)',     dose:'1 cap with meal 1',              directions:'Daily',                   code:'', link:'https://www.amazon.com/Nutricost-Vitamin-Supplement-Capsules-Pyridoxal-5-Phosphate/dp/B08YS9T41V/'},
  ],
  'NuEthix Products':[
    {name:'Cort-Eaze',              dose:'As prescribed', directions:'See adrenal protocol',  code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/cort-eaze?variant=32244757364781'},
    {name:'Estro-Cort',             dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('estro-cort')},
    {name:'Thyro-Boost+',           dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('thyro-boost-plus')},
    {name:'Adrena-Health',          dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('adrena-health')},
    {name:'Liposomal L-Carnitine',  dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('liposomal-l-carnitine')},
    {name:'Nu-Multi',               dose:'3 caps with meal 1', directions:'Daily',             code:'TOGNIETTI10', link:NEX('nu-multi')},
    {name:'GDA-MAX Pro',            dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('gda-max-pro')},
    {name:'Jumpstart EC',           dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('jumpstart-ec-new')},
    {name:'Nu-Lytes Electrolytes',  dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('nu-lytes-electrolytes')},
    {name:'Nu-D3+K2',               dose:'1 tab daily',   directions:'With meal',              code:'TOGNIETTI10', link:NEX('nu-d3-k2')},
    {name:'Fatty Acids Pro',        dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('fatty-acids-pro')},
    {name:'Nu-Youth+ Collagen',     dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('nu-youth-collagen-protein')},
    {name:'Prosorb+ Magnesium',     dose:'1 scoop before bed', directions:'Nightly',           code:'TOGNIETTI10', link:NEX('prosorb-magnesium-new')},
    {name:'Essential Energy BCAA',  dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('essential-energy-bcaa-eaa-keto-salts')},
    {name:'Ashwagandha KSM-66',     dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('ashwagandha-ksm-66')},
    {name:'Nu-Creatine',            dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('nu-creatine')},
    {name:'Slin-Trol',              dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('slin-trol')},
    {name:'Herbal Adrena+',         dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('herbal-adrena')},
    {name:'Cellular Restore Kit',   dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('cellular-restore-bundle')},
    {name:'Nu-Glutamine',           dose:'20g daily',     directions:'With a meal',            code:'TOGNIETTI10', link:NEX('nu-glutamine')},
    {name:'ISO-Perfect Protein',    dose:'1 scoop',       directions:'As needed',              code:'TOGNIETTI10', link:NEX('iso-perfect-with-digestive-support')},
    {name:'DHEA Capsules',          dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('dhea-capsules')},
    {name:'Restful Sleep',          dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('restful-sleep')},
    {name:'Nu-Woman',               dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('nu-woman')},
    {name:'Stress Support',         dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('stress-support')},
    {name:'Nu-Protein Blend',       dose:'1 scoop',       directions:'As needed',              code:'TOGNIETTI10', link:NEX('nu-protein-blend')},
    {name:'Medipure Ultra',         dose:'1 scoop',       directions:'As needed',              code:'TOGNIETTI10', link:NEX('medipure-ultra')},
    {name:'Gut Health Bundle',      dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('flora-protect-gut-defender-bundle')},
    {name:'Ultimate Calm & Sleep',  dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('ultimate-calm-sleep-stack')},
    {name:'Flora-Protect',          dose:'1 cap upon waking', directions:'Fasted daily',       code:'TOGNIETTI10', link:NEX('flora-protect')},
    {name:'Bloat Eaze',             dose:'1 scoop morning fasted', directions:'Daily fasted',  code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/bloat-eaze-pro?variant=42854686753001'},
    {name:'Biofilm Resolve',        dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/biofilm-resolve?variant=37274128482466'},
    {name:'Opti-Pure',              dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/opti-pure?variant=42315272585449'},
    {name:'Relax Liposomal',        dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/relax-liposomal?variant=32244904689709'},
    {name:'Gut Defender',           dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/gut-defender-new?variant=37158070845602'},
    {name:'Methyl B12 Folate',      dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/b12-liposomal?selling_plan=4335665385'},
    {name:'Utilyze',                dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('utilyze')},
    {name:'Gourmet Greens',         dose:'As prescribed', directions:'',                       code:'TOGNIETTI10', link:NEX('gourmet-greens')},
  ],
  'Extra Supplements':[
    {name:'5-HTP',               dose:'100mg',           directions:'1 hour before bed',       code:'', link:'https://www.amazon.com/dp/B01A1DL4DW'},
    {name:'L-Dopa (Mucuna)',     dose:'As prescribed',   directions:'',                        code:'', link:'https://www.amazon.com/Nutricost-Mucuna-Pruriens-400mg-Capsules/dp/B07JHN2JK6/'},
    {name:'Magnesium Glycinate', dose:'350mg',           directions:'1 hour before bed',       code:'', link:'https://www.amazon.com/dp/B0CV2RSRFX'},
    {name:'Chasteberry',         dose:'As prescribed',   directions:'',                        code:'TOGNIETTI10', link:'https://nuethix.com/products/chasteberry'},
    {name:'Collagen',               dose:'As prescribed',  directions:'',                             code:'TOGNIETTI10', link:NEX('nu-youth-collagen-protein')},
    {name:'Passion Flower Extract', dose:'As prescribed',  directions:'',                             code:'', link:'https://www.amazon.com/Nutricost-Passion-Extract-Equivalent-Capsules/dp/B09P49D4HC/'},
    {name:'Vitamin B12',            dose:'As prescribed',  directions:'',                             code:'TOGNIETTI10', link:'https://nuethix.com/collections/supplements/products/b12-liposomal?selling_plan=4335665385'},
    {name:'L-Theanine',             dose:'200-400mg',      directions:'Morning or before bed',        code:'', link:'https://www.amazon.com/Nutricost-L-Theanine-200mg-240-Capsules/dp/B0731JC54K/'},
    {name:'Phosphatidylserine',     dose:'As prescribed',  directions:'',                             code:'', link:'https://www.amazon.com/dp/B08XYDDXDC'},
    {name:'Methylfolate',           dose:'As prescribed',  directions:'',                             code:'', link:'https://www.amazon.com/Nutricost-Methyl-Folate-1000mcg-Capsules/dp/B07T8C9N97/'},
    {name:'HCL with Pepsin',        dose:'As prescribed',  directions:'With protein meals',           code:'', link:'https://www.amazon.com/Nutricost-Betaine-Pepsin-750mg-Capsules/dp/B077NS1KDK/'},
    {name:'DIM',                    dose:'As prescribed',  directions:'',                             code:'', link:'https://www.amazon.com/Nutricost-Diindolylmethane-BioPerine-Veggie-Capsules/dp/B01HQR0RZW/'},
    {name:'Black Seed Oil',         dose:'10g daily',      directions:'Daily',                        code:'', link:'https://www.amazon.com/Organic-Black-Seed-Oil-Liquid/dp/B0B2R57WWC/'},
    {name:'CoQ10',                  dose:'1500mg daily',   directions:'Daily',                        code:'', link:'https://www.amazon.com/s?k=CoQ10+Ubiquinol+200mg'},
    {name:'Alpha Lipoic Acid',      dose:'300mg daily',    directions:'Away from food',               code:'', link:'https://www.amazon.com/Nutricost-R-Alpha-Lipoic-100mg-Capsules/dp/B09NS4HZZB/'},
    {name:'NAC',                    dose:'600-1200mg 2-3x daily', directions:'Empty stomach or 30min before meals', code:'', link:'https://www.amazon.com/Nutricost-N-Acetyl-L-Cysteine-600mg-Capsules/dp/B01CUQFKW4/'},
    {name:'TUDCA',                  dose:'250-500mg 2x daily', directions:'With meals — liver support', code:'', link:'https://www.amazon.com/Nutricost-Tudca-500mg-Capsules-Tauroursodeoxycholic/dp/B07WFRD1ST/'},
    {name:'Niacin Flush',           dose:'As prescribed',  directions:'',                             code:'', link:'https://www.amazon.com/s?k=Niacin+flush+nicotinic+acid'},
    {name:'Iodine',                 dose:'225mcg daily',   directions:'With meal',                    code:'', link:'https://www.amazon.com/dp/B00V9Q6IZQ'},
    {name:'L-Carnitine',            dose:'3g daily',       directions:'Between meals',                code:'TOGNIETTI10', link:NEX('liposomal-l-carnitine')},
    {name:'Seeking Health Electrolytes', dose:'As prescribed', directions:'',                         code:'', link:'https://www.amazon.com/Electrolyte-Servings-Seeking-Health-Replacement/dp/B00O2JQWCA/'},
    {name:'Blue Light Glasses',     dose:'Wear at night',  directions:'Wear 2hrs before bed',         code:'', link:'https://www.amazon.com/dp/B086WQ1CL8'},
    {name:'Soy Isoflavones',        dose:'As prescribed',  directions:'',                             code:'', link:'https://www.amazon.com/Nutricost-Isoflavones-150mg-Veggie-Capsules/dp/B09NS3PKCH/'},
    {name:'Vitamin B1',             dose:'As prescribed',  directions:'',                             code:'', link:'https://www.amazon.com/Nutricost-Vitamin-Thiamine-100mg-Capsules/dp/B07L1C5JHZ/'},
    {name:'Nu-Lytes',               dose:'As prescribed',  directions:'',                             code:'TOGNIETTI10', link:NEX('nu-lytes-electrolytes')},
    {name:'Bromelain',              dose:'As prescribed',  directions:'',                             code:'', link:'https://www.amazon.com/Nutricost-Bromelain-500mg-Veggie-Capsules/dp/B07TK4ZTLP/'},
  ],
}
...
export default function DietBuilder({currentUser}) {
  ...
  function addSuppFromDB(supp) {
    setClientSupps(p=>[...p,{...supp,id:Date.now(),customDose:supp.dose,customDir:supp.directions}])
  }
