...
const SUPP_DB = {
  ...
  'Juice Plus+':[
    {name:'Juice Plus+ Orchard Blend',   dose:'2 capsules daily', directions:'With meal',          code:'', link:'https://us.juiceplus.com/10628434', reason:'Concentrated whole food nutrition from 10 fruits. Provides antioxidants, phytonutrients, and vitamins in bioavailable form — not a replacement for fruit, but a whole-food bridge.'},
    {name:'Juice Plus+ Garden Blend',    dose:'2 capsules daily', directions:'With meal',          code:'', link:'https://us.juiceplus.com/10628434', reason:'Concentrated nutrition from 10 vegetables. Supports alkalinity, detox pathways, and micronutrient density from whole-food sources.'},
    {name:'Juice Plus+ Vineyard Blend',  dose:'2 capsules daily', directions:'With meal',          code:'', link:'https://us.juiceplus.com/10628434', reason:'Concentrated nutrition from grapes, berries, and other deeply pigmented fruits. High in polyphenols, OPCs, and resveratrol for cardiovascular and antioxidant support.'},
    {name:'Juice Plus+ Complete Shake',  dose:'2 scoops',         directions:'As a meal or snack', code:'', link:'https://us.juiceplus.com/10628434', reason:'Plant-based whole food meal replacement. Clean protein from plant sources with fiber and phytonutrients. Suitable as a bridge meal or post-workout option.'},
    {name:'Juice Plus+ Omega Blend',     dose:'2 softgels daily', directions:'With meal',          code:'', link:'https://us.juiceplus.com/10628434', reason:'Plant-based omega-3, -5, -6, -7, and -9 blend from algae, pomegranate, and sea buckthorn. Anti-inflammatory support without fish-sourced oils.'},
    {name:'Juice Plus+ Chewables',       dose:'2 chewables daily',directions:'Anytime',            code:'', link:'https://us.juiceplus.com/10628434', reason:'Same whole-food concentrate as the capsules in chewable form. Useful for clients who have difficulty swallowing capsules.'},
  ],
  'Extra Supplements':[
