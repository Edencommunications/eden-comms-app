...
const EXERCISE_LIBRARY = {
  ...
  'Upper': [
    ...
    'Pec Deck Fly','Incline DB Fly','Flat DB Fly','Low Cable Fly','High Cable Fly','Incline Cable Fly',
    'Rear Delt Pec Deck Fly','Cable Rear Delt Fly','Bent Over DB Rear Delt Fly',
  ],
  'Push': [
    'Flat DB Bench Press','Flat BB Bench Press','Incline DB Bench Press',
    ...
    'Plate Front Raise','Chest Dips','Machine Dips',
    'Pec Deck Fly','Incline DB Fly','Flat DB Fly','Decline DB Fly',
    'Low Cable Fly','High Cable Fly','Incline Cable Fly','Decline Cable Fly','Flat Cable Fly',
  ...
  'Pull': [
    ...
    'Rear Delt Pec Deck Fly','Cable Rear Delt Fly','Bent Over DB Rear Delt Fly',
    'Bent Over Cable Rear Delt Fly','Single Arm Bent Over DB Rear Delt Fly',
  ],
  'Lower': [
    'BB Back Squat','BB Front Squat','Safety Bar Squat','Hack Squat',
