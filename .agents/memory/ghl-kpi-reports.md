...
- Weekly dedupe marker is the REPORTED WEEK's start date (Central), never "today's date" — a UTC-date marker double-posts after UTC midnight while it's still the same Central day. Post day-of-week, payout day-of-month, and closer calendar list are all admin-configurable in the config.
